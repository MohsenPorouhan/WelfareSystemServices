...
<!-- 
Template Name: Responsive Admin Dashboard Template build with Twitter Bootstrap 3.1.1
Version: 2.0.2
Author: KeenThemes
...
<body class="login">
    ...
    <div class="content">
        ...
        <form class="login-form" method="post" action="login.aspx" runat="server">
            ...
            <div class="alert alert-danger display-hide" id="myDiv" runat="server">
                <button class="close" data-close="alert"></button>
                <span id="mySpan" runat="server">نام کاربری یا کلمه عبور خود را وارد نمایید.
                </span>
            </div>
            ...
            <div class="form-actions">
                <label class="checkbox">
                    <input runat="server" type="checkbox" id="checkboxId" name="remember" value="1" />
                    من را به یاد بیاور
                </label>
            ...
            <div class="forget-password">
                ...
                <p>
                    نگران نباشید، جهت بازنشانی کلمه عبور 
				<a href="javascript:;" id="forget-password">اینجا را
                </a>
                    کلیک کنید
                </p>
            </div>
            <div class="create-account">
				...
				<a href="javascript:;" id="register-btn">Create an account
                </a>
                </p>
            </div>
        </form>
